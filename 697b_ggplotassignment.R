...
repressmodeldata$csrepress.r.1 <- case_when(repressmodeldata$csrepress.r %in% c("Weak") ~ 1,
                                            repressmodeldata$csrepress.r %in% c("None", "Moderate", "Substantial", "Severe") ~ 0)

repressmodeldata$csrepress.r.2 <- case_when(repressmodeldata$csrepress.r %in% c("Moderate") ~ 1,
                                            repressmodeldata$csrepress.r %in% c("Weak", "None", "Substantial", "Severe") ~ 0)

repressmodeldata$csrepress.r.3 <- case_when(repressmodeldata$csrepress.r %in% c("Substantial") ~ 1,
                                            repressmodeldata$csrepress.r %in% c("Weak", "Moderate", "None", "Severe") ~ 0)

repressmodeldata$csrepress.r.4 <- case_when(repressmodeldata$csrepress.r %in% c("Severe") ~ 1,
                                            repressmodeldata$csrepress.r %in% c("Weak", "Moderate", "Substantial", "None") ~ 0)
